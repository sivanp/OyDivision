function [u v] = fullPyrMotion_trans(im1, im2, mask)
...
for i = length(p1):-1:2  %%MM%% was: 3
    ...
    if (exist('mask'))
        [translation(1) translation(2)] = fullMotion_trans(p1{i}, p2{i}, translation, margin, pm{i});
    else
        [translation(1) translation(2)] = fullMotion_trans(p1{i}, p2{i}, translation, margin);
    end
end
